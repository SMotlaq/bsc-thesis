...
شکل \ref{fig:sch-oled} شماتیک مداری بخش نمایشگر را نشان می‌دهد. درگاه ارتباطی این نمایشگر، باس \lr{I2C} است. به همین دلیل \lr{I2C1} پردازنده به این حسگر متصل است.
...
این ماسفت یک ماسفت \lr{P-Channel} است. در صورتی هدایت می‌کند که شرط
\lr{$V_{GS}<V_{th}=-0.9$}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{sch_buz}
