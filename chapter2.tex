\chapter{سخت‌افزار و الکترونیک} \label{chap:hardware}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=0.7\linewidth]{charge_real}
